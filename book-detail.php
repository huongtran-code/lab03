...
<body>
            ...
            <div class="preview-section">
                <div class="preview-header">
                    <div>
                        ...
                        <strong>Xem trước: <?=htmlspecialchars($book['title'])?></strong>
                    </div>
                    <div class="pdf-nav">
                ...
                <div class="preview-content" id="previewContent">
                    ...
                    <!-- Buy Now CTA - appears when scrolling to limit -->
    ...
    <script>
        ...
        pdfjsLib.getDocument(pdfUrl).promise.then(function(pdf) {
            ...
            // Render 1/5 of total pages
            document.getElementById('pdfCanvasContainer').innerHTML = '';
            for (let i = 1; i <= maxPreview; i++) {
                renderPage(i);
            }
            updateNavButtons();
            // Setup scroll detection for buy-now CTA
            setupScrollDetection();
        }).catch(function(error) {
            document.getElementById('pdfCanvasContainer').innerHTML = '<p style="color: white; text-align: center; padding: 40px;">Không thể tải sách. Vui lòng thử lại.</p>';
        });
